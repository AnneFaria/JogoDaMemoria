...
const IMAGES = [
    { key: 'cat1 (1)', src: 'img/cat1 (1).jpg', alt: 'cat' },
    { key: 'cat2 (1)', src: 'img/cat2 (1).jpg', alt: 'cat' },
    { key: 'cat3 (1)', src: 'img/cat3 (1).jpg', alt: 'cat' },
    { key: 'cat4 (1)', src: 'img/cat4 (1).jpg', alt: 'cat' },
    { key: 'cat5 (1)', src: 'img/cat5 (1).jpg', alt: 'cat' },
    { key: 'cat6 (1)', src: 'img/cat6 (1).jpg', alt: 'cat' },
    { key: 'cat7 (1)', src: 'img/cat7 (1).jpg', alt: 'cat' },
    { key: 'cat8 (1)', src: 'img/cat8 (1).jpg', alt: 'cat' },
    { key: 'cat9 (1)', src: 'img/cat9 (1).jpg', alt: 'cat' }
];
